...
/***/ function(module, exports, __webpack_require__) {
	...
	var i18n = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var realTimeLineChart = function realTimeLineChart() {
		...
		var brush = __webpack_require__(14);
		var _this = this;
		...
		function draw() {
			...
			var chart = svgContainer.append('g').attr('class', 'chartWrap').attr("transform", "translate(" + margin[1] + "," + margin[0] + ")");
			...
			function drawLegend() {
				...
				legendApi = legend.defaultLegend.call(chart, {
					...
					// transOffset: [40,10],
					cellclick: function cellclick(name, i, e) {
			...
			if (config.fillType === 'area') {
				fillTypeFunc = d3.svg.area().interpolate(config.interpolate).x(function (d, i) {
					return axis.x(d.x);
				}).y0(axis.y(0)).y1(function (d, i) {
					return axis.y(d.y);
				});
			} else {
				fillTypeFunc = d3.svg.line().interpolate(config.interpolate).x(function (d, i) {
					return axis.x(d.x);
				}).y(function (d, i) {
					return axis.y(d.y);
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		...
		var commonConfig = {
			...
			brushDataFormat: function brushDataFormat(startPos, endPos) {
				if (!endPos) {
					endPos = startPos + 10;
				}
				return {
		...
		if (d3.select('#brush_' + chartId).empty()) {
			brushWrap = mlpChartApi.config.wrapContainer.append("div").attr({
				id: 'brush_' + chartId,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiHelper = __webpack_require__(18);
	var events = __webpack_require__(19);
	var elementHelper = __webpack_require__(20);
	var foramt = __webpack_require__(21);
	var i18n = __webpack_require__(22);
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  * @returns {number}
	  */
		findCloestNumber: function findCloestNumber(num, operation) {
			var searchArr = this;
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		dataFormatRange: function dataFormatRange(range, mode) {
			range = Number(range);
			var modeConfig = {
				days: true,
				hours: true,
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var language = {
		"zh": __webpack_require__(23),
		"en": __webpack_require__(24)
	};
	module.exports = {
		i18n: "zh",
